    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="pt-5">
                ...
                <form method="POST" action="{{ route('patient.store') }}" class="flex flex-wrap">
                    @csrf
                    <fieldset class="flex-grow w-2/4">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <x-input id="firstname" class="flex-grow block mt-1 w-3/4" type="text" name="firstname" :value="old('firstname')" autofocus />
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <x-label for="lastname" :value="__('Lastname')" class="w-1/4 text-right pr-4"/>

                            <x-input id="lastname" class="flex-grow block mt-1 w-3/4" type="text" name="lastname" :value="old('lastname')" />
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <x-label for="mi" :value="__('Middle Initial')" class="w-1/4 text-right pr-4"/>

                            <x-input id="mi" class="flex-grow block mt-1 w-3/4" type="text" name="mi" :value="old('mi')" />
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <x-label for="gender" :value="__('Gender')" class="w-1/4 text-right pr-4"/>
                            <x-select :options="$gender" :selectedOption="old('gender')" class="flex-grow block mt-1 w-3/4" name="gender" id="gender"/>
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <x-label for="dob" :value="__('Date of birth')" class="w-1/4 text-right pr-4"/>
                            <x-input id="dob" class="flex-grow block mt-1 w-3/4" type="date" name="dob" :value="old('dob')" />
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <x-label for="mobile" :value="__('Mobile')" class="w-1/4 text-right pr-4"/>
                            <x-input id="mobile" class="flex-grow block mt-1 w-3/4" type="text" name="mobile" :value="old('mobile')" />
                        </div>
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <x-input id="name" class="flex-grow block mt-1 w-3/4" type="text" name="name" :value="old('name')"/>
                        </div>
                        <!-- Email Address -->
                        <div class="mt-4 flex items-center justify-between">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <x-input id="password" class="flex-grow block mt-1 w-3/4" type="password" name="password"/>
                        </div>
                    </fieldset>
                    <fieldset class="flex-grow w-2/4">
